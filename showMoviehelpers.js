...
async function createMovieCard(moviedata) 
{
	...
	content = 
	`<div id="${moviedata.imdbID}"class="moviecards col-sm-4 card border-secondary sm-3" style="max-width: 20rem; min-width: 20rem; align-items: center; border-color: var(--info); margin-top: 20px; margin-bottom: 20px;" onmouseover="movieHoverIn(this)" onmouseout="movieHoverOut(this)" onclick="loadInfo('`+ moviedata.imdbID +`','`+moviedata.Year+`')">
